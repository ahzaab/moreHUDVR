...
$releaseDir = "$($Env:ModDevPath)\MODS\SkyrimVR\moreHUD\Release"
...
$requiredDataDirs = @("Interface","Scripts","Source\Scripts" , "Interface\exported", "Interface\translations", "SKSE\Plugins", "meshes", "Interface\vr")
...
New-Item -ItemType Directory "$tempDir\Data\meshes"
New-Item -ItemType Directory "$tempDir\Data\Interface\vr"
...
#include additional loose files that have to overwrite the vr build
