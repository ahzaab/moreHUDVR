...
$destinationDataPath = "$($Env:ModDevPath)\MODS\SkyrimVR\moreHUD\SKSE64\sksevr\moreHUD\Data"
$destinationAS2Path = "$($Env:ModDevPath)\MODS\SkyrimVR\moreHUD\SKSE64\sksevr\moreHUD\AS2"
...
Copy-Item "$sourcePath\ahz*.esp" -Destination "$destinationDataPath"
